...
class CourseServiceImplTest {
    ...
    void getCalendarEntries() {
        ...
        when(courseRepository.findAllBetweenFromAndTo(from, to)).thenReturn(Set.of(course));

        var calendarEntryDtoSet = courseService.getCalendarEntriesBetweenFromAndTo(from, to);
