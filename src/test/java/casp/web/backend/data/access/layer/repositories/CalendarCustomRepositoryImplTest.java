...
class CalendarCustomRepositoryImplTest {
    ...
    class FindAllBetweenEventFromAndEventToAndEventTypes {
        ...
        void onlyFromYesterday() {
            assertThat(calendarRepository.findAllBetweenEventFromAndEventToAndEventTypes(yesterday.getEventFrom().toLocalDate(), yesterday.getEventFrom().toLocalDate(), null))
