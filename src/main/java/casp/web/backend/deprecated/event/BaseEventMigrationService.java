...
public class BaseEventMigrationService {
    ...
    private Set<casp.web.backend.calendar.data.participants.Space> mapToSpaceV2(UUID id) {
    ...
    private Set<casp.web.backend.calendar.data.participants.CoTrainer> mapToCoTrainerV2(UUID id) {
